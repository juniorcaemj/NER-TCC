...
#HYPER PARAMETERS
windowSize = 5 # 3 to the left, 3 to the right
number_of_epochs = 50
#minibatch_size = 5000
minibatch_size = 20
...
for epoch in xrange(number_of_epochs):
    ...
    #Train for 1 epoch
    hist = model.fit(train_x, train_y_cat, nb_epoch=1, batch_size=minibatch_size, verbose=False, shuffle=True,show_accuracy=False,)
    ...
    model.save_weights('modelos_treinados/5-LSTM_batch20_comjanela5/parciais/modelo_parcial'+str(epoch+1)+'.h5',overwrite=True)

#Save final model
model.save_weights('modelos_treinados/5-LSTM_batch20_comjanela5/modelo_final.h5',overwrite=True)
