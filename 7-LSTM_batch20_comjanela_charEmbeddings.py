...
for epoch in xrange(number_of_epochs):
    ...
    model.save_weights('modelos_treinados/7-LSTM_batch20_comjanela_charEmbeddings/parciais/modelo_parcial'+str(epoch+1)+'.h5',overwrite=True)
...
#Save final model
model.save_weights('modelos_treinados/7-LSTM_batch20_comjanela_charEmbeddings/modelo_final.h5',overwrite=True)