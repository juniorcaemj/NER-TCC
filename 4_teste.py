...
for i in xrange(1,50):
    model.load_weights('modelos_treinados/4-LSTM_batch200_semjanela/parciais/modelo_parcial'+str(i)+'.h5')

#model.load_weights('modelos_treinados/3-LSTM_batch200_comjanela/modelo_final.h5')
    print '\nTesting...'
