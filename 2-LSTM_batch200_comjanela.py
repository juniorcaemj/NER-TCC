...
for epoch in xrange(number_of_epochs):
    ...
    model.save_weights('modelos_treinados/2-LSTM_batch200_comjanela/parciais/modelo_parcial'+str(epoch+1)+'.h5',overwrite=True)

#Save final model
model.save_weights('modelos_treinados/2-LSTM_batch200_comjanela/modelo_final.h5')
